...
{
	//Generowanie kluczy !!
	//generuj_klucze("C:\\Users\\Erni\\Desktop\\Krypto", 20);
	...
	{
		BOOL check = koduj(argv[2], (char *)password.c_str(), pobierz_klucz("C:\\Users\\Erni\\Desktop\\Krypto", argv[3]));
		if (check)
		{
	...
	{
		BOOL check = odkoduj(argv[2], (char *)password.c_str(), pobierz_klucz("C:\\Users\\Erni\\Desktop\\Krypto", argv[3]));

		if (check)
		{
			cout << "odkodowano" << endl;
		}
		else
		{
	...
	//PlaySound(TEXT("C:\\Users\\Erni\\\Desktop\muza.mp3"), NULL, SND_FILENAME | SND_ASYNC);
